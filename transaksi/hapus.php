...
if(isset($_GET['id'])){
	...
	$cek = mysql_query("SELECT transaksi_id FROM transaksi WHERE transaksi_id='$id'") or die(mysql_error());
	...
	if(mysql_num_rows($cek) == 0){
		...
		$del = mysql_query("DELETE FROM transaksi WHERE transaksi_id='$id'");
		
		//jika query DELETE berhasil
		if($del){
			
			echo 'Data transaksi berhasil di hapus! ';		//Pesan jika proses hapus berhasil
