...
if(isset($_POST['simpan'])){
	...
	$update = mysql_query("UPDATE pegawai SET pegawai_nama='$nama', pegawai_jabatan='$jabatan', pegawai_alamat='$alamat', pegawai_jk='$jk', pegawai_umur='$umur', pegawai_notlp='$notlp' WHERE pegawai_id='$id'") or die(mysql_error());
