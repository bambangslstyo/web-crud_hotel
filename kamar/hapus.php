...
if(isset($_GET['id'])){
	...
	$cek = mysql_query("SELECT kamar_id FROM kamar WHERE kamar_id='$id'") or die(mysql_error());
	...
	if(mysql_num_rows($cek) == 0){
		...
		$del = mysql_query("DELETE FROM kamar WHERE kamar_id='$id'");
		
		//jika query DELETE berhasil
		if($del){
			
			echo 'Data kamar berhasil di hapus! ';		//Pesan jika proses hapus berhasil
