...
if(isset($_GET['id'])){
	...
	$cek = mysql_query("SELECT tamu_id FROM tamu WHERE tamu_id='$id'") or die(mysql_error());
	...
	if(mysql_num_rows($cek) == 0){
		...
		$del = mysql_query("DELETE FROM tamu WHERE tamu_id='$id'");
		
		//jika query DELETE berhasil
		if($del){
			
			echo 'Data tamu berhasil di hapus! ';		//Pesan jika proses hapus berhasil
